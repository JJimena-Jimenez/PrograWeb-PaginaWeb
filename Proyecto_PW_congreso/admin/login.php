...
/* ============================================================
   ...
   FUNCIÓN: Página de acceso al panel de administrador
   ============================================================
   - URL de acceso: /admin/login.php
   - Si ya está logueado como admin → redirige a dashboard.php
   - Al enviar el formulario (POST):
       1. Busca el usuario en la tabla 'admins'
       2. Verifica contraseña con password_verify() (bcrypt)
       3. Si es correcto: guarda $_SESSION['admin_id'] y redirige
       4. Si falla: muestra error en el formulario

   CREDENCIALES POR DEFECTO:
   - Usuario: admin
   - Contraseña: Admin2026!
   (cambiar después de instalar con genhash.php)
   ============================================================ */
